...
public class SubmissionServiceImpl implements SubmissionService {
    ...
    public FacetedSearchSubmissions getSubmissions(Integer page, Integer itemsPerPage, String sortType) {
        ...
        int totalPages = (page.intValue() == -1 && itemsPerPage == -1) ? 1 : computeTotalPages(totalItems, itemsPerPage);
    ...
    private static int computeTotalPages(int totalItems, int itemsPerPage) {
